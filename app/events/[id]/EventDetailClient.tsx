              ...
              <div className="ticket-event-card">
                <div className="ticket-card-body">
                  ...
                  {/* Listener count and Preview Artist share one row, matching
                      the mockup — they were two separate block-level elements
                      before, which is why they stacked onto their own lines. */}
                  {(event.spotify_monthly_listeners || event.spotify_featured_track || event.spotify_url) && (
                    <div className="ticket-spotify-inline-row">
                      {event.spotify_monthly_listeners && (
                        <p className="ticket-spotify-listeners">
                          <svg width="12" height="12" viewBox="0 0 24 24" fill="currentColor" style={{ flexShrink: 0, marginTop: 1 }}>
                      ...
                      {(event.spotify_featured_track || event.spotify_url) && (
                        <>
                          {event.spotify_monthly_listeners && <span className="ticket-spotify-inline-sep">·</span>}
                          <button
                          ...
                          >
                            <svg width="9" height="10" viewBox="0 0 9 10" fill="currentColor" style={{ flexShrink: 0 }}>
