              ...
              <div className="offer-potential-grid">
                <div className="offer-potential-col">
                  ...
                  <div className="offer-potential-row">
                    ...
                    <strong style={{ color: "#ffffff", fontSize: 16 }}>{avgTicketPrice > 0 ? (pnlGuarantee / avgTicketPrice).toLocaleString("en-US", { minimumFractionDigits: 2, maximumFractionDigits: 2 }) : "0.00"} tickets</strong>
                  </div>
                </div>
              </div>
            </div>
