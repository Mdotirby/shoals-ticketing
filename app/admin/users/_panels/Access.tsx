...
/**
 * ACCESS — the capability matrix and the sidebar editor, inside the identity
 * hub rather than off on their own route.
 *
 * Who someone is, what they can do, and which portal they get in through are
 * one subject. They were three pages: /admin/users, /admin/settings/permissions
 * and /portal. Splitting them is how an admin changes a role here and forgets
 * the portal invitation over there.
 *
 * The page title is gone because MergedPage supplies it — everything else is
 * the permissions page unchanged.
 */

import { useEffect, useState } from "react";
import { DEFAULT_TAB_ROLES } from "@/lib/admin/nav";
import { getCookie } from "@/lib/cookies";
import AccessControl from "@/app/admin/settings/permissions/AccessControl";
