...
const sidebarItems: SidebarItem[] = [
  ...
  { label: "Private Events",    href: "/admin/private-events",      roles: ["owner","venue_admin"] },
  ...
  { label: "Venue Marketing",    href: "/admin/venue-marketing",     roles: ["owner","venue_admin","full_admin"] },
...
const TAB_KEY_MAP: Record<string, string> = {
  ...
  "Marketing": "marketing",
  "Venue Marketing": "venue_marketing",
  "Agents": "agents",
