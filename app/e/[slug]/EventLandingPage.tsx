...
// Shared with InlineCheckout.tsx — see lib/stripeAppearance.ts. This file
// previously kept its own copy using colorPrimary/borderColor values built
// from var(--vc-gold-rgb): Stripe renders these fields inside a cross-origin
// iframe that can't see this page's :root custom properties, so that var()
// silently failed to resolve and the card fields fell back to Stripe's
// default black-on-white instead of the intended white-on-dark.
