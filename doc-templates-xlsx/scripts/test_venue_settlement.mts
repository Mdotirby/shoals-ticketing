...
// Bonus/ticketing_rebate wiring. 3 ticket tiers (template stencil has 4 --
// exercises row deletion this time, the opposite direction from the
// artist-settlement stress test) and a nonzero ticketing_rebate.
const settlement: Settlement = {
  ...
  ticket_audit: [
    { tier: "VIP Table", capacity: 11, sold: 10, comps: 0, kills: 1, price: 800, ticketing_fee: 3, facility_fee: 0, gross: 8000 },
    { tier: "GA Section 1", capacity: 196, sold: 196, comps: 0, kills: 0, price: 75, ticketing_fee: 3, facility_fee: 0, gross: 14700 },
    { tier: "GA Section 2", capacity: 224, sold: 224, comps: 0, kills: 0, price: 50, ticketing_fee: 3, facility_fee: 0, gross: 11200 },
  ],
  ...
  artist_total: 20571.95,
  deposit_paid: 0,
  cash_advance: 0,
  balance_due: 21552.95,
  bar_revenue: 0,
